...
import { Calendar, Clock, CheckCircle, AlertCircle, TrendingUp, XCircle, FileText, ChevronDown, ChevronUp, List, Trash2 } from "lucide-react";
...
export function ProfessionalDashboard() {
  const { appointments, fetchAppointmentsSilent, updateStatus, deleteAppointment, isLoading, searchFilters, updateSearchFilters, clearSearchFilters, fetchWithSearch } = useAppointments();
